...
export default async function CouponsPage() {
  ...
  // بناء الـ ItemList Schema ديناميكياً لكامل القائمة من جهة السيرفر
  const jsonLdSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Today's Best Coupons & Promo Codes | Savvy Bee Deals",
    "description": "Browse the latest verified coupon codes and deals from top international brands.",
    "url": "https://savvybeedeals.com/coupons",
    ...
    "itemListElement": coupons.map((coupon: any, index: number) => ({
      ...
      "item": {
        "@type": "Product",
        "name": coupon.title,
        "description": coupon.description || `Get exclusive discount with our promo code.`,
        "image": coupon.store?.logo || "https://savvybeedeals.com/favicon.ico",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD",
  ...
  return (
    <>
      {/* حقن الـ Schema برمجياً داخل السيرفر لعناكب البحث */}
      <script
