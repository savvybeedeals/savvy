...
export default function CategoryClient({ params }: CategoryClientProps) {
  ...
  // حالات الـ State لإدارة جلب البيانات والـ Limit الذكي لـ 12 عنصر (مطابق لملفك 100%)
  ...
  // جلب البيانات من الـ Sanity Client بشكل متزامن وآمن تماماً بنفس استعلاماتك الأصلية
  useEffect(() => {
