...
export default async function DealsPage() {
  ...
  // بناء الـ ItemList Schema الخاص بقائمة الـ Deals المجلوبة
  const jsonLdSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Exclusive Product Deals & Price Drops | Savvy Bee Deals",
    "description": "Browse the latest verified product discounts, price drops, and exclusive deals from top international brands.",
    "url": "https://savvybeedeals.com/deals",
    ...
    "itemListElement": deals.map((deal: any, index: number) => ({
      ...
      "item": {
        "@type": "Product",
        "name": deal.title,
        "description": deal.description || `Exclusive validated price drop deal.`,
  ...
  return (
    <>
      {/* حقن سكيما الـ ItemList لصفحة الـ Deals الفاخرة */}
      <script
